...
export const ListsHeader = () => {
  ...
  return (
    <header className="pointer-events-none flex gap-2 items-center justify-between px-4 py-2 text-lg shadow-md shadow-slate-300 border-b-2 border-slate-300 z-10 sticky bg-white top-0  w-full overflow-hidden">
